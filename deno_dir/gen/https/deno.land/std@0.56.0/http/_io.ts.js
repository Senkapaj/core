...
export async function writeTrailers(w, headers, trailers) {
    ...
    for (const f of trailerHeaderFields) {
        assert(!isProhibidedForTrailer(f), `"${f}" is prohibited for trailer header`);
    }
...
//# sourceMappingURL=file:///Users/marianhahne/Code/Senkapaj/core/deno_dir/gen/https/deno.land/std@0.56.0/http/_io.ts.js.map