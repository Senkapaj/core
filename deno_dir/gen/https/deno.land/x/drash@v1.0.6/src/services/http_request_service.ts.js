...
export class HttpRequestService {
     ...
     */
    getRequestBodyFile(parsedBody, input) {
     ...
     * @return any
     */
    getRequestBodyParam(parsedBody, input) {
     ...
     * @return string
     */
    getRequestHeaderParam(request, input) {
     ...
     * @return string
     */
    getRequestPathParam(request, input) {
     ...
     * @return string
     */
    getRequestUrlQueryParam(request, input) {
     ...
     */
    getResponseContentType(request, defaultContentType = "application/json") {
    ...
    async hydrate(request, options) {
        ...
        request.response_content_type = this.getResponseContentType(request, contentType);
        ...
        // convenience here.
        const pb = await this.parseBody(request, options);
        // Attach methods
        const t = this;
        request.getBodyFile = function getRequestBodyFile(input) {
            return t.getRequestBodyFile(pb, input);
        };
        request.getBodyParam = function getRequestBodyParam(input) {
            return t.getRequestBodyParam(pb, input);
        };
        request.getHeaderParam = function getRequestHeaderParam(input) {
            return t.getRequestHeaderParam(request, input);
        };
        request.getPathParam = function getRequestPathParam(input) {
            return t.getRequestPathParam(request, input);
        };
        request.getUrlQueryParam = function getRequestUrlQueryParam(input) {
            return t.getRequestUrlQueryParam(request, input);
        };
        request.getCookie = function getCookie(name) {
            return t.getCookie(request, name);
        };
        request.accepts = function accepts(type) {
     ...
     */
    async parseBody(request, options = {}) {
        let ret = {
            content_type: "",
            data: undefined,
        };
        ...
        if (contentType && contentType.includes("multipart/form-data")) {
            ...
            try {
                ...
                ret.data = await this.parseBodyAsMultipartFormData(request.body, boundary, maxMemory);
     ...
     */
    async parseBodyAsFormUrlEncoded(request) {
...
//# sourceMappingURL=file:///Users/marianhahne/Code/Senkapaj/core/deno_dir/gen/https/deno.land/x/drash@v1.0.6/src/services/http_request_service.ts.js.map